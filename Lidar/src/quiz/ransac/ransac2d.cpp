...
std::unordered_set<int> RansacP(pcl::PointCloud<pcl::PointXYZ>::Ptr cloud, int maxIterations, float distanceTol)
{
  std::unordered_set<int> inliersResult;
...
int main ()
{
	...
	std::unordered_set<int> inliers = RansacPlane(cloud, 15, 0.3);
